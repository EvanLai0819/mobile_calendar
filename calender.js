...
var mobile_calender = {
    ...
    target: "",
    init: function () {
        html = '<div id="mid"></div><div class="calendar"> <div class="calender_header"> <div class="calender_title">选择日期</div> <div class="week"> <span class="week_item holiday">日</span> <span class="week_item">一</span> <span class="week_item">二</span> <span class="week_item">三</span> <span class="week_item">四</span> <span class="week_item">五</span> <span class="week_item holiday">六</span></div></div><div class="calender_tools"><div class="chose_year_btn"></div> <div class="chose_month_btn"> </div> </div> <div class="calender_content"> <div class="day"> </div></div><div class="footer_month"><div class="footer_title">选择月份 <span class="footer_close"><img src="close.png" width="24" height="24"></span> </div><div class="chose_month"> <span class="chose_month_item" data-month="1" id="chose_month_1">1月</span><span class="chose_month_item" data-month="2" id="chose_month_2">2月</span> <span class="chose_month_item" data-month="3" id="chose_month_3">3月</span> <span class="chose_month_item" data-month="4" id="chose_month_4">4月</span> <span class="chose_month_item" data-month="5" id="chose_month_5">5月</span> <span class="chose_month_item" data-month="6" id="chose_month_6">6月</span> <span class="chose_month_item" data-month="7" id="chose_month_7">7月</span> <span class="chose_month_item" data-month="8" id="chose_month_8">8月</span> <span class="chose_month_item" data-month="9" id="chose_month_9">9月</span> <span class="chose_month_item" data-month="10" id="chose_month_10">10月</span> <span class="chose_month_item" data-month="11" id="chose_month_11">11月</span> <span class="chose_month_item" data-month="12" id="chose_month_12">12月</span> </div> </div> <div class="footer_year"> <div class="footer_title">选择年份 <span class="footer_close"><img src="close.png" width="24" height="24"></span> </div> <div class="chose_year"> <div class="chose_year_tools"> <span class="chose_yt_item"><img src="back.png" class="chose_year_back_btn"></span><span class="chose_yt_item"><img src="quickBack.png" class="chose_year_quickBack_btn"></span><span class="chose_yt_item"><input id="_year" value=""> </span><span class="chose_yt_item"><img src="quickNext.png" class="chose_year_quickNext_btn"></span><span class="chose_yt_item"><img src="next.png" class="chose_year_next_btn"></span> </div> <div class="chose_year"><span class="btn_red chose_year_button chose_year_certain_button">确定</span> <span class="btn_grey chose_year_button chose_year_cancel_button">取消</span></div></div></div> </div>';
        $("body").append(html);
        var mydate = new Date();
        //获取当前年份
